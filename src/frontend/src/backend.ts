...
import type { AttendanceRecord as _AttendanceRecord, PhoneNumber as _PhoneNumber, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1 } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStudent(arg0: bigint, arg1: string, arg2: PhoneNumber): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createClass(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAttendance(arg0: bigint, arg1: bigint): Promise<AttendanceRecord | null> {
        if (this.processError) {
            try {
    ...
    async getClassStudents(arg0: bigint): Promise<Array<Student>> {
        if (this.processError) {
            try {
    ...
    async getStudentAttendanceHistory(arg0: bigint): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentAttendanceHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTeacherClasses(): Promise<Array<Class>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTeacherClasses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async takeAttendance(arg0: bigint, arg1: bigint, arg2: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.takeAttendance(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "teacher" in value ? UserRole.teacher : "parent" in value ? UserRole.parent : value;
}
